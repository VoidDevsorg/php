...
.card .banner {
  background-image: url("img/cs16background2.jpg");
...
.profile-card__img {
  ...
  position: relative;
  z-index: 4;
  box-shadow: 0px 5px 50px 0px #0093FF, 0px 0px 0px 7px rgba(107, 74, 255, 0.5);
}
...
<script>
  ...
  <div style="margin-top: 13%; margin-bottom: 100px"class="profile-card js-profile-card">
  <div class="profile-card__img">
      <img src="https://cdn.discordapp.com/avatars/<?php  print_r($user->id) ?>/<?php print_r($user->avatar) ?>.png">
    </div>

    <div class="profile-card__cnt js-profile-cnt">
 
      <div class="profile-card__name"><?php echo $user->username ?></div>
      <div class="profile-card__txt" style="color: #fff">Hi, <strong><?php echo $user->username ?>!</strong></div>
      <br>
      <p style="color: #fff;"><strong>ID:</strong> <?php echo $user->id ?>
      <br><strong>Avatar: </strong> <?php echo $user->avatar ?>
      <br><strong>Discriminator:</strong> <?php echo $user->discriminator ?>
      <br><strong>flags:</strong> <?php echo $user->flags ?>
      <br><strong>mfa_enabled:</strong> <?php echo $user->mfa_enabled ?>
      <br><strong>public_flags:</strong> <?php echo $user->public_flags ?></p>
      <div class="profile-card-inf">


      
      <div class="profile-card-ctr">
      <button onclick="location.href ='tickets.php'" class="profile-card__button button--orange"><i class="fa fa-ticket"></i> Tickets</button>
        <button onclick="location.href ='?action=logout'" class="profile-card__button button--orange"><i class="fa fa-sign-out"></i> Logout</button>
